          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-2xl font-bold text-gray-900">Campusia</span>
              </div>
            </div>
            <p className="text-gray-700 max-w-2xl mx-auto">
              Hãy liên hệ với Campusia Để Được hỗ trợ nhanh chóng, giải Đáp thắc mắc hoặc trao Đổi cơ hội hợp tác.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-300 py-8">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="space-y-2 mb-6">
              <p className="text-gray-900">Campusia@company.com</p>
              <p className="text-gray-900">0827775001</p>
              <p className="text-gray-900">Trường đại học FPT Hà Nội</p>
            </div>

            {/* Social Media Icons */}
            <div className="flex items-center justify-center space-x-4">
              <a href="#" className="w-10 h-10 bg-white rounded flex items-center justify-center hover:bg-gray-100 transition-colors">
